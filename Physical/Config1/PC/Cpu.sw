...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  ...
  <TaskClass Name="Cyclic#4">
    <Task Name="MainProgra" Source="MainProgram.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="TestMotor" Source="TestMotor.prg" Memory="UserROM" Language="IEC" Debugging="true" />
