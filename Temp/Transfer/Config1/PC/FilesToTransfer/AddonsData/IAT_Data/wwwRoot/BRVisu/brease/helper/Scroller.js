define(['libs/iscroll-probe', 'brease/core/Utils', 'brease/events/BreaseEvent'], function (IScroll, Utils, BreaseEvent) {
    ...
    */
    ...
    function onFocusIn(e) {
        // check if element receives focus due to mouse or touch input => no auto scroll
        if (!e.target.matches(':active')) {
            //args: el, time, offsetX, offsetY
            // offsetX = true => center element on the screen
            this.scrollToElement(e.target, 0, true, true);
        }
    }
