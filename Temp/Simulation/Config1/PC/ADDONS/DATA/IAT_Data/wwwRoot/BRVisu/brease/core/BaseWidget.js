...
function (SuperClass, BreaseEvent, VirtualEvents, Utils, Enum, Types, EventHandler, permissions, fileManager, AsyncProcess, tooltipDependency) {
    ...
    */
    ...
    p._addKeyboardOperationListeners = function () {
        ...
        this.addEventListener('keydown', this._bind(this._handleFocusKeyDown));
        this.addEventListener('keyup', this._bind(this._handleFocusKeyUp));
    ...
    p._removeKeyboardOperationListeners = function () {
        this.removeEventListener('keydown', this._bind(this._handleFocusKeyDown));
        this.removeEventListener('keyup', this._bind(this._handleFocusKeyUp));
     ...
     * Emulates a virtual mouse down event for enter key.
     ...
     * Emulates a virtual mouse up & click event for enter key.
     * @param {*} e KeyboardEvent
     */
    ...
    */
    ...
    /**
    * @method isFocusable
    * Checks visiblity, enable and tabindex if the widget is focusable
    * This function can be only used if keyboardOperation=true
    */
    p.isFocusable = function () {
        return this.settings.tabIndex > -1 && this.isVisible() && this.isEnabled() && Utils.isVisible(this.elem);
    };
