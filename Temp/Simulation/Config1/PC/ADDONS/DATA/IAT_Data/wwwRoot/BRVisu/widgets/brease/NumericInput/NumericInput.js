define([
...
], function (SuperClass, languageDependency, measurementSystemDependency, Enum, Types, Node, keyboardManager, BreaseEvent, NumberFormat, Config, Utils, BoxLayout, UtilsObject, dragAndDropCapability) {
    ...
    function _initEventHandler(widget) {
        ...
        if (widget._getUseKeyboardOperations()) widget.elem.addEventListener(BreaseEvent.BEFORE_FOCUS_MOVE, widget._bind('_onBeforeFocusMove'));
    }
